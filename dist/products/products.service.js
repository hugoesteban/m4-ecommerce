...
let ProductsService = class ProductsService {
    ...
    async createProductsService(newProduct) {
    ...
    async findAllProductsService(page, limit) {
        return this.productsRepository.findAll(page, limit);
    }
    async findOneProductsService(id) {
        return this.productsRepository.findOne(id);
    }
    async updateProductsService(id, updateProduct) {
